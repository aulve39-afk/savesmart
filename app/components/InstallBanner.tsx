...
const DISMISSED_KEY = 'savesmart_install_dismissed'
...
export default function InstallBanner() {
  ...
  if (show === 'ios') {
    return (
      <div
        role="dialog"
        aria-label="Installer SaveSmart"
        style={{
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
        ...
        <div style={{ flex: 1 }}>
          <p style={{ fontWeight: '800', fontSize: '14px', margin: '0 0 2px', color: 'var(--text-primary)' }}>Installer SaveSmart</p>
